...
from dook.api.auth.serializers import (
    AuthTokenSerializer,
...
class SignUpView(generics.CreateAPIView):
    ...
    def create(self, request, token=None, *args, **kwargs):
        ...
        serializer.validated_data["domain"] = invitation.domain
        ...
        serializer.validated_data.pop("domain")
...
class CreateInvitationView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if not existing_invitation.is_invalidated():
        ...
        self._send_invitation(request=request, invitation=invitation)

        return Response(
            data=serializer.to_representation(invitation), status=status.HTTP_201_CREATED
        )
